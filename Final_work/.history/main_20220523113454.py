# encodeing: utf-8
"""
@project = Learn_gesture
@file = FlipPageControl
@author = XinYu
...
while True:
    ...
    if len(lmList) != 0:
        ...
        # distance_05 = math.sqrt((y_0-y_5)**2+(x_0-x_5)**2)
        # distance_58 = math.sqrt((y_5-y_8)**2+(x_5-x_8)**2)
        # print(distance_58/distance_05)
    else:
        if_hand = 0     # 表示画面中没手
    cTime = time.time()
